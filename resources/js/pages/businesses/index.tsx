...
import { ArrowRight, Briefcase, Plus, Receipt, Trash2 } from 'lucide-react';
...
export default function BusinessesIndex({ businesses, stats }: Props) {
    const { t } = useI18n();
            ...
            <div className="flex min-h-screen flex-col gap-4">
                <PageBanner
                    stats={[
                        {
                            key: 'total',
                            label: t('bannerBusinesses'),
                            value: stats.total,
                            icon: Briefcase,
                        },
                        {
                            key: 'transactions',
                            label: t('bannerTransactions'),
                ...
                <PagePanel className="flex-1">
                    {businesses.length === 0 ? (
                        <div className="flex flex-col items-center gap-3 rounded-xl px-4 py-12 text-center">
